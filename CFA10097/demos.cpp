//============================================================================
//
// Some demo routines for Crystalfontz CFA10097 FT8xx accelerated displays.
//
...
uint16_t Add_Bitmap_To_Display_List(uint16_t FWol)
  ...
  FWol=FT8xx_Cmd_Dat_0(FWol,
                       BEGIN(BITMAPS));
  FWol=FT8xx_Cmd_Dat_0(FWol,
                       BITMAP_SOURCE(Bitmap_RAM_G_Address));
  FWol=FT8xx_Cmd_Dat_0(FWol,
                       BITMAP_LAYOUT(RGB565,LCD_WIDTH*2,LCD_HEIGHT));
  FWol=FT8xx_Cmd_Dat_0(FWol,
                       BITMAP_SIZE(NEAREST,BORDER,BORDER,LCD_WIDTH,LCD_HEIGHT));
...
uint16_t Add_Marble_To_Display_List(uint16_t FWol)
  ...
  FWol=FT8xx_Cmd_Dat_0(FWol,
                       BITMAP_SIZE(
                       BILINEAR, // BILINEAR, //NEAREST is less work
                       BORDER,
                       BORDER,
                       marble_width,
                       marble_height));
